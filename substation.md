...
```bash
yolo detect train model=yolov8m.pt data=ultralytics/cfg/datasets/insulator.yaml epochs=300 patience=300 batch=24 imgsz=1280 device=0,1,2,3 project=../../experiments/insulator_det name=1.0 pretrained=True seed=8888 cos_lr=True degrees=30 shear=30
```
